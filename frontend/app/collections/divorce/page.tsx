...
export default function MitzvahShowcasePage() {
  const showcaseImages = ["use client";

import Navbar from "../../../components/Navbar";
import Footer from "../../../components/Footer";

export default function DivorceShowcasePage() {
  const showcaseImages = [
    { id: 1, alt: "Finally Free", src: "https://via.placeholder.com/600x400/0a0a0a/FF00FF?text=Finally+Free" },
    { id: 2, alt: "Thank U Next", src: "https://via.placeholder.com/600x400/0a0a0a/FF1493?text=Thank+U+Next" },
    { id: 3, alt: "Boy Bye", src: "https://via.placeholder.com/600x400/0a0a0a/FF4500?text=Boy+Bye" },
    { id: 4, alt: "Happily Divorced", src: "https://via.placeholder.com/600x400/0a0a0a/00BFFF?text=Happily+Divorced" },
    { id: 5, alt: "End of an Error", src: "https://via.placeholder.com/600x400/0a0a0a/39FF14?text=End+of+an+Error" },
    { id: 6, alt: "Single & Ready", src: "https://via.placeholder.com/600x400/0a0a0a/FFD700?text=Single+%26+Ready" },
    { id: 7, alt: "Un-tied The Knot", src: "https://via.placeholder.com/600x400/0a0a0a/FF00FF?text=Un-tied" },
    { id: 8, alt: "Freedom", src: "https://via.placeholder.com/600x400/0a0a0a/1E90FF?text=Freedom" },
    { id: 9, alt: "Next Chapter", src: "https://via.placeholder.com/600x400/0a0a0a/FF69B4?text=Next+Chapter" },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-dark-bg text-black dark:text-white font-sans transition-colors duration-300">
      ...
      <main className="flex-grow pt-32 pb-24 px-6 max-w-7xl mx-auto w-full">
        {/* Bright Orange/Red Title */}
        <h1 className="text-3xl md:text-5xl font-bold text-center text-[#FF4500] uppercase mb-12 tracking-wide drop-shadow-[0_0_8px_rgba(255,69,0,0.5)]">
          Divorce Neons We Did
        </h1>
