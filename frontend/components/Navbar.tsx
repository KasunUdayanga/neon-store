          ...
          <div className="hidden sm:flex items-center justify-center p-1">
            ...
            <Show when="signed-out">
              <SignInButton mode="redirect">
                <button
                  type="button"
                  className="cursor-pointer text-gray-800 dark:text-white hover:text-neon-pink transition"
                  aria-label="Sign in"
                >
      ...
      {isMobileMenuOpen && (
        <>
          ...
          <div className="lg:hidden absolute top-full left-0 w-full bg-white dark:bg-zinc-950 border-b border-gray-200 dark:border-zinc-800 shadow-2xl flex flex-col font-medium z-50 animate-in slide-in-from-top-4 fade-in duration-200">
            ...
            {/* Mobile Profile Link */}
            <div className="px-6 py-5 flex items-center gap-3 text-gray-700 dark:text-gray-300">
              <Show when="signed-in">
              ...
              <Show when="signed-out">
                <SignInButton mode="redirect">
                  <button
                    type="button"
                    className="flex items-center gap-3 w-full text-left hover:text-neon-pink transition"
                  >
                    <User size={20} />
                    <span>My Account</span>
                  </button>
